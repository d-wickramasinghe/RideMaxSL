...
if (isset($_POST['update'])) {
    ...
    $con->query("UPDATE reservations SET pickup_location='$pickup_location', return_location='$return_location', pickup_date='$pickup_date', pickup_time='$pickup_time', return_date='$return_date', return_time='$return_time', number_of_days='$number_of_days', vehicle_type='$vehicle_type' WHERE id=$id");
    header('location: vehicle_reservation.php');
}
?>
