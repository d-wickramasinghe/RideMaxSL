<footer class="footer">
    <div class="footer-div1">
        ...
        <div class="footer-link-section">
            <h3>Quick Links</h3>
            <ul class="footer-ul">
                <li class="footer-list"><a href="index.php">Home</a></li>
                <li class="footer-list"><a href="vehicle.php">Vehicles</a></li>
                <li class="footer-list"><a href="services.php">Services</a></li>
                <li class="footer-list"><a href="about.php">About Us</a></li>
                <li class="footer-list"><a href="contactus.php">Contact Us</a></li>
    ...
    <div class="footer-bottom">
        <p class="footer-para2">&copy; 2024 Vehicle Rental. All Rights Reserved. | <a href="privacy.php">Privacy Policy</a> | <a href="termsconditions.php">Terms & Conditions</a></p>
    </div>
</footer>
