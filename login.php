...
<body class="body" style="background-image: url('newbg.jpg');">
    ...
    <div class="div1login">
        ...
        <div style="text-align: center; margin-top: 15px;">
            <button onclick="window.location.href='admin_login.php'" class="loginbtn" style="background-color: #333; color: #ffcc00; width: 100%;">Admin Login</button>
        </div>

        <div class="signup-link">
            <p>Don't have an account? <a href="registeras.php">Sign up here</a></p>
        </div>
    </div>
