...
<body>
    ...
    <div class="about" style="flex: 1; width: 100%; max-width: 1000px; margin: 40px auto; box-sizing: border-box;">
        <div class="help-content">
            <h1 class="headings">How Can We Help You?</h1>
            <p class="para">At Ride Max SL, we are committed to providing you with the best vehicle rental experience possible. Below, you'll find answers to frequently asked questions and information on how to get help with our services.</p>
            ...
            <div class="faq-card">
                ...
                <p class="para">Yes, you can modify or cancel your booking through the <a href="reservationread.php">My Bookings</a> section. Please note that cancellation policies may apply, depending on the time of cancellation.</p>
            </div>

            <div class="faq-card">
                <h3 class="headings">4. How can I contact customer service?</h3>
                <p class="para">You can reach our customer service team 24/7 via phone, email, or live chat. Visit our <a href="contactus.php">Contact Us</a> page for more details.</p>
            </div>
            ...
            <ul>
                <li class="para"><strong>Phone:</strong> +1 800 123 4567 (24/7 Support)</li>
                <li class="para"><strong>Email:</strong> support@ridemaxsl.com</li>
                <li class="para"><strong>Live Chat:</strong> Available on our website 24/7</li>
            </ul>

            <h2 class="headings">Rental Policies</h2>
            <p class="para">For detailed information regarding our rental policies, please refer to the <a href="termsconditions.php">Rental Policies</a> page.</p>

            <h2 class="headings">Terms and Conditions</h2>
            <p class="para">To review our terms and conditions, please visit the <a href="termsconditions.php">Terms and Conditions</a> page.</p>
