...
<body class="body">
    ...
    <div style="flex: 1; width: 100%; box-sizing: border-box;">
       <div style="display: flex; width: 100%;">
           <img src="images/vehicle page/2.jpg" alt="Hero Banner" style="width: 50%; height: 300px; object-fit: cover;">
           <img src="images/vehicle page/4.webp" alt="Hero Banner" style="width: 50%; height: 300px; object-fit: cover;">
       </div>
